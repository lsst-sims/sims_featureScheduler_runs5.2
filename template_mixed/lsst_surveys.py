...
def standard_bf(
    ...
    # Make sure N templates are taken. Turns off after 365 days by default
    if bandname2 is not None:
        bfs.append(
            (
                bf.NObsPerYearBasisFunction(
                    bandname=bandname, nside=nside, n_obs=n_obs_template,footprint=footprints.get_footprint(bandname),
                ),
        ...
        bfs.append(
            (
                bf.NObsPerYearBasisFunction(
                    bandname=bandname2, nside=nside, n_obs=n_obs_template, footprint=footprints.get_footprint(bandname2),
                ),
